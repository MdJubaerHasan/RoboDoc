...
public class DBHelperDoctor extends SQLiteOpenHelper {
    ...
    public void insert(){
        ...
        insertData(db,"ডাঃ শেক মান্না রোশিদ","সিলেট ওসমানী মেডিকেল কলেজ হাসপাতাল","mannaroshid999211@gmail.com","0172-1667911","Sylhet MAG Osmani Medical College Hospital, Medical College Road, Sylhet, hospital",24.900596413779294, 91.85328506698413);
